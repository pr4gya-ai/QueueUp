            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6">
                <div className="text-center mb-16">
                    ...
                    <h2 className="font-serif font-medium text-4xl sm:text-5xl leading-tight text-gray-900">
                        ...
                        <br />
                        <span className="text-pink-500 italic">of growth</span>
                    </h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-5 items-start">
                    {pricingPlans.map((plan) => (
                        <div
                            key={plan.name}
                            className={`rounded-2xl border p-7 flex flex-col gap-6 relative ${
                                plan.highlight
                                    ? "bg-gradient-to-br from-orange-50 via-white to-pink-50 text-slate-900 border-orange-200 shadow-2xl shadow-orange-100"
                        ...
                        >
                            ...
                            <div>
                                <div
                                    className={`text-sm font-semibold mb-1 ${
                                        plan.highlight ? "text-pink-600" : "text-orange-500"
                                    }`}
                                >
                                    {plan.name}
                                </div>
                            ...
                            <Link
                                to="/#"
                                className={`mt-auto text-center font-semibold text-sm px-6 py-3 rounded-full transition-all ${
                                    plan.highlight
                                        ? "bg-gradient-to-r from-orange-500 to-pink-500 text-white hover:from-orange-600 hover:to-pink-600 hover:shadow-lg hover:shadow-orange-200"
